...
The app icon uses the “Pile of Poo” emoji from
[Microsoft Fluent Emoji](https://github.com/microsoft/fluentui-emoji) (3D
style, **MIT**). The icon is generated by `tools/iconforge`, which can also use
Noto (Apache-2.0) or Twemoji (CC-BY 4.0) — see `tools/iconforge/THIRD-PARTY.md`.
